 ...
 */
public class MessageQuantityReport extends Report implements MessageListener {
	...
	private int nrofFakeMsg;

	/**
	 * Constructor.
	 */
	public MessageQuantityReport() {
		init();
	}
	...
	public void done() {
		...
		write((this.nrofCreated-this.nrofFakeMsg) + " Reals " + scenName);
		write(this.nrofFakeMsg + " Falsos " + scenName);
