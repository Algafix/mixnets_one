...
public class Message implements Comparable<Message> {
	...
	private DTNHost to;
	public List<DTNHost> mixlist;
	public int mixindex;
	public double mixcreationtime;
	public DTNHost realto;
	public String lastfwd;
	//public DTNHost mix1, mix2, mix3;
	...
	public Message(DTNHost from, DTNHost to, String id, int size) {
		...
		this.mixlist = new ArrayList<DTNHost>();
		this.mixcreationtime = 0;
		this.mixindex = 0;
	 ...
	 * @return the node this message is originally to
	 */
	public void setTo(DTNHost host) {
			this.to = host;
	}
	...
	protected void copyFrom(Message m) {
		...
		this.appID = m.appID;
		this.mixindex = m.mixindex;
		this.lastfwd = m.lastfwd;
		
		this.mixlist = new ArrayList<DTNHost>(m.mixlist);
		this.mixcreationtime = m.mixcreationtime;
